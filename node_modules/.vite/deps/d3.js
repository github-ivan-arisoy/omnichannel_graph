...
function radial_default(radius, x4, y4) {
  ...
  if (typeof radius !== "function") radius = constant_default3(+radius);
  if (x4 == null) x4 = 0;
  if (y4 == null) y4 = 0;
  function force(alpha) {
...
function x_default2(x4) {
  ...
  if (typeof x4 !== "function") x4 = constant_default3(x4 == null ? 0 : +x4);
  function force(alpha) {
    for (var i = 0, n = nodes.length, node; i < n; ++i) {
...
function boundsRingEnd() {
  ...
  areaStream.lineEnd();
  if (abs2(deltaSum) > epsilon5) lambda02 = -(lambda1 = 180);
  range3[0] = lambda02, range3[1] = lambda1;
  p0 = null;
}
...
function circle_default() {
  var center = constant_default4([0, 0]), radius = constant_default4(90), precision = constant_default4(2), ring, rotate, stream = { point: point6 };
  ...
  circle.center = function(_) {
    return arguments.length ? (center = typeof _ === "function" ? _ : constant_default4([+_[0], +_[1]]), circle) : center;
  };
  ...
  return {
    ...
    point: function(lambda12, phi12) {
      ...
      if (abs2(delta - pi3) < epsilon5) {
        ...
        if (abs2(lambda04 - sign0) < epsilon5) lambda04 -= sign0 * epsilon5;
        if (abs2(lambda12 - sign1) < epsilon5) lambda12 -= sign1 * epsilon5;
...
function clipAntimeridianIntersect(lambda04, phi02, lambda12, phi12) {
  ...
  return abs2(sinLambda0Lambda1) > epsilon5 ? atan((sin2(phi02) * (cosPhi1 = cos2(phi12)) * sin2(lambda12) - sin2(phi12) * (cosPhi03 = cos2(phi02)) * sin2(lambda04)) / (cosPhi03 * cosPhi1 * sinLambda0Lambda1)) : (phi02 + phi12) / 2;
}
...
function circle_default2(radius) {
  var cr = cos2(radius), delta = 2 * radians, smallRadius = cr > 0, notHemisphere = abs2(cr) > epsilon5;
  ...
  function intersect2(a4, b, two) {
    ...
    var delta2 = lambda12 - lambda04, polar = abs2(delta2 - pi3) < epsilon5, meridian = polar || delta2 < epsilon5;
    if (!polar && phi12 < phi02) z = phi02, phi02 = phi12, phi12 = z;
    if (meridian ? polar ? phi02 + phi12 > 0 ^ q[1] < (abs2(q[0] - lambda04) < epsilon5 ? phi02 : phi12) : phi02 <= q[1] && q[1] <= phi12 : delta2 > pi3 ^ (lambda04 <= q[0] && q[0] <= lambda12)) {
...
function resample(project, delta2) {
  function resampleLineTo(x06, y06, lambda04, a0, b0, c0, x12, y12, lambda12, a1, b1, c1, depth, stream) {
    ...
    if (d2 > 4 * delta2 && depth--) {
      var a4 = a0 + a1, b = b0 + b1, c6 = c0 + c1, m3 = sqrt2(a4 * a4 + b * b + c6 * c6), phi2 = asin(c6 /= m3), lambda22 = abs2(abs2(c6) - 1) < epsilon5 || abs2(lambda04 - lambda12) < epsilon5 ? (lambda04 + lambda12) / 2 : atan2(b, a4), p = project(lambda22, phi2), x22 = p[0], y22 = p[1], dx2 = x22 - x06, dy2 = y22 - y06, dz = dy * dx2 - dx * dy2;
...
function conicEqualAreaRaw(y06, y12) {
  ...
  if (abs2(n) < epsilon5) return cylindricalEqualAreaRaw(y06);
...
function conicConformalRaw(y06, y12) {
  ...
  project.invert = function(x4, y4) {
    var fy = f - y4, r = sign(n) * sqrt2(x4 * x4 + fy * fy), l = atan2(x4, abs2(fy)) * sign(fy);
    if (fy * n < 0)
...
function conicEquidistantRaw(y06, y12) {
  ...
  if (abs2(n) < epsilon5) return equirectangularRaw;
  function project(x4, y4) {
    var gy = g - y4, nx = n * x4;
...
function arc_default() {
  ...
  function arc() {
    ...
    if (!(r1 > epsilon6)) context.moveTo(0, 0);
      ...
      var a01 = a0, a11 = a1, a00 = a0, a10 = a1, da0 = da2, da1 = da2, ap = padAngle.apply(this, arguments) / 2, rp = ap > epsilon6 && (padRadius ? +padRadius.apply(this, arguments) : sqrt3(r0 * r0 + r1 * r1)), rc = min2(abs3(r1 - r0) / 2, +cornerRadius.apply(this, arguments)), rc0 = rc, rc1 = rc, t0, t1;
      if (rp > epsilon6) {
